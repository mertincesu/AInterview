  ...
  try {
    const apiResponse = await axios.post('https://api.openai.com/v1/chat/completions', {
      ...
      messages: [
        ...
        {
          role: 'user',
          content: `In less than 50 words, provide ONLY constructive but fair feedback (without saying anything else) for this interview response. Question: "${question}" Response: "${userResponse}"`,
        },
      ],
      max_tokens: 100,
      temperature: 0.7,
